...
const string strMessageMagic = "GitCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60;; // GitCoin: 0.35 days
static const int64 nTargetSpacing = 120; // GitCoin: 15 seconds
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GitCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Homeless Cats Recruited to Fight Rising Tide of Rats";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
